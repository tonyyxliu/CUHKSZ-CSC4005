 ...
 * Matmul Auto Vec
 */
Matrix matrix_multiply_autovec(const Matrix& matrix1, const Matrix& matrix2,
                               size_t block_size)
{
    if (matrix1.getCols() != matrix2.getRows())
    {
    ...
    /**
     * TODO: Auto-Vec Build upon Task 1 ~ 4
     */
...
int main(int argc, char** argv)
{
    ...
    Matrix result = matrix_multiply_autovec(matrix1, matrix2, block_size);
